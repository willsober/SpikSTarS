...
quick_encoding_files = [file for file in os.listdir(folder_path) if file.startswith("Quick_Encoding_Linear_Weighted8_Seed")]
...
plt.savefig('plots/smartfall_over_all.png')
plt.show()
